...
methods of Markov blanket inference, two causal filter and a supervised method
are applied. We draw general conclusions on the possible causes of churn, helped
with prior knowledge of experts at Orange Belgium.
...
variable et la création de nouvelles variables. La directionalité de l'impact
...
données d'observation. Plus spécifiquement, nous utilisons un réseau Bayesien
